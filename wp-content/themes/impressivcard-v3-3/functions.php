		...
		?>
			<div class="admin-inside-box">
				...
				<p>
					...
					<textarea id="short_description" name="short_description" style="outline: none; resize: vertical; padding: 7px; width: 100%;" rows="2" cols="50"><?php echo stripcslashes( get_option( $post->ID . 'short_description' ) ); ?></textarea>
				</p>
...
/* ============================================================================================================================================= */
	...
	if ( function_exists( 'register_sidebar' ) )
	{
		...
		register_sidebar( array('name' => __( 'Pages', 'impressivcard' ),
								'id' => 'pages',
								'description' => __( 'Use this widget area for custom theme widgets.', 'impressivcard' ),
								'before_widget' => '',
								'after_widget' => '',
								'before_title' => '<span style="display: none;">',
								'after_title' => '</span>' ) );
	}
	// end if register_sidebar
	...
	class Portfolio_Widget extends WP_Widget
	{
		public function __construct()
		{
			parent::__construct('portfolio_widget',
								__( 'ivCard - Portfolio', 'impressivcard' ),
		...
		public function form( $instance )
		{
			...
			?>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php echo __( 'Title:', 'impressivcard' ); ?></label>
				...
				<!-- slug -->
				<p>
					<label for="<?php echo $this->get_field_id( 'slug' ); ?>"><?php echo __( 'Pages:', 'impressivcard' ); ?></label>
				...
				<p>
					...
					<label>
						...
						<input type="checkbox" id="<?php echo $this->get_field_id( 'portfolio_editor_content' ); ?>" name="<?php echo $this->get_field_name( 'portfolio_editor_content' ); ?>" <?php if ( $portfolio_editor_content ) { echo 'checked="checked"'; } ?> value="portfolio_editor_content"> Enable editor content
						
					</label>
					
				</p>
				<!-- end Enable editor content -->
				
				<!-- Enable content on the top -->
				<p>
				
					<label>
					
						<input type="checkbox" id="<?php echo $this->get_field_id( 'portfolio_top_content' ); ?>" name="<?php echo $this->get_field_name( 'portfolio_top_content' ); ?>" <?php if ( $portfolio_top_content ) { echo 'checked="checked"'; } ?> value="portfolio_top_content"> Enable content on the top
						
					</label>
					
				</p>
				<!-- end Enable content on the top -->
				
				<!-- portfolio_x -->
				<p>
				
					<label for="<?php echo $this->get_field_id( 'portfolio_x' ); ?>"><?php echo __( 'X-Axis:', 'impressivcard' ); ?></label>
					
					<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'portfolio_x' ); ?>" name="<?php echo $this->get_field_name( 'portfolio_x' ); ?>" value="<?php echo esc_attr( $portfolio_x ); ?>">
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id( 'portfolio_y' ); ?>"><?php echo __( 'Y-Axis:', 'impressivcard' ); ?></label>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id( 'portfolio_scale' ); ?>"><?php echo __( 'Scale:', 'impressivcard' ); ?></label>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id( 'portfolio_rotate' ); ?>"><?php echo __( 'Rotate:', 'impressivcard' ); ?></label>
	...
	class Page_Widget extends WP_Widget
	{
		public function __construct()
		{
			parent::__construct('page_widget',
								__( 'ivCard - Custom Page', 'impressivcard' ),
								array( 'description' => __( 'Resume, Contact, About Me', 'impressivcard' ) ) );
		}
		...
		public function form( $instance )
		{
			...
			?>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id( 'custom_page' ); ?>"><?php echo __( 'Pages:', 'impressivcard' ); ?></label>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id( 'page_x' ); ?>"><?php echo __( 'X-Axis:', 'impressivcard' ); ?></label>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id( 'page_y' ); ?>"><?php echo __( 'Y-Axis:', 'impressivcard' ); ?></label>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id( 'page_scale' ); ?>"><?php echo __( 'Scale:', 'impressivcard' ); ?></label>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id( 'page_rotate' ); ?>"><?php echo __( 'Rotate:', 'impressivcard' ); ?></label>
...
/* ============================================================================================================================================= */
	...
	function my_login()
	{
		...
		else
		{
			...
			{
				echo '<style type="text/css">h1 a { cursor: default; background-image: url("' . get_option( 'login_logo' ) . '") !important; }</style>';
			}
			// end if
		}
		// end if
