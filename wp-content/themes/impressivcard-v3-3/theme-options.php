												...
												<table>
													...
													<tr>
														<td class="option-left">
															...
															<textarea id="text_slogan" name="text_slogan" style="width: 100%;" rows="1" cols="50"><?php echo stripcslashes( get_option( 'text_slogan' ) ); ?></textarea>
														</td>
										...
										<div class="inside">
											<form method="post" action="<?php admin_url( 'themes.php?page=theme-options' ); ?>" class="ajax-form">
												...
												<table>
													...
													<tr>
														<td class="option-left">
															<label><input type="checkbox" id="enable_safe_mod" name="enable_safe_mod" <?php if ( get_option( 'enable_safe_mod' ) ) { echo 'checked="checked"'; } ?> value="enable_safe_mod"> Enable Safe Mode</label>
														</td>
														
														<td class="option-right">
															Deactivates 3D layout for every device. Acticates the classic layout.
														</td>
													</tr>
													
													<tr>
														<td class="option-left">
															<label><input type="checkbox" id="disable_mobile_safe_mod" name="disable_mobile_safe_mod" <?php if ( get_option( 'disable_mobile_safe_mod' ) ) { echo 'checked="checked"'; } ?> value="disable_mobile_safe_mod"> Disable Mobile Safe Mode</label>
														</td>
														
														<td class="option-right">
															Activates 3D layout for smartphones.
														</td>
													</tr>
												...
												<table>
													...
													<tr>
														<td class="option-left">
															...
															<label><input type="checkbox" id="glow" name="glow" <?php if ( get_option( 'glow' ) ) { echo 'checked="checked"'; } ?> value="glow"> Glow</label>
															
															<br>
															
															<label><input type="checkbox" id="light_glow" name="light_glow" <?php if ( get_option( 'light_glow' ) ) { echo 'checked="checked"'; } ?> value="light_glow"> Light Glow</label>
															
															<br>
															
															<label><input type="checkbox" id="noise" name="noise" <?php if ( get_option( 'noise' ) ) { echo 'checked="checked"'; } ?> value="noise"> Noise</label>
															
															<br>
															
															<label><input type="checkbox" id="overlay" name="overlay" <?php if ( get_option( 'overlay' ) ) { echo 'checked="checked"'; } ?> value="overlay"> Overlay</label>
															
															<br>
															
															<label><input type="checkbox" id="alternate_portfolio" name="alternate_portfolio" <?php if ( get_option( 'alternate_portfolio' ) ) { echo 'checked="checked"'; } ?> value="alternate_portfolio"> Alternate Portfolio</label>
															
															<br>
															
															<label><input type="checkbox" id="portfolio_transparent" name="portfolio_transparent" <?php if ( get_option( 'portfolio_transparent' ) ) { echo 'checked="checked"'; } ?> value="portfolio_transparent"> Portfolio Transparent</label>
															
															<br>
															
															<label><input type="checkbox" id="pf_details_light_transparent" name="pf_details_light_transparent" <?php if ( get_option( 'pf_details_light_transparent' ) ) { echo 'checked="checked"'; } ?> value="pf_details_light_transparent"> Portfolio Details Light Transparent</label>
															
															<br>
															
															<label><input type="checkbox" id="pf_details_dark_transparent" name="pf_details_dark_transparent" <?php if ( get_option( 'pf_details_dark_transparent' ) ) { echo 'checked="checked"'; } ?> value="pf_details_dark_transparent"> Portfolio Details Dark Transparent</label>
															
															<br>
															
															<label><input type="checkbox" id="retro" name="retro" <?php if ( get_option( 'retro' ) ) { echo 'checked="checked"'; } ?> value="retro"> Retro</label>
														</td>
