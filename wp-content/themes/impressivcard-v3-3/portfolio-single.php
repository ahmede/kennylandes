					...
					while ( have_posts() ) : the_post();
						?>
							...
							<div class="span4 portfolio-field portfolio-nav">
								<?php
									next_post_link( '<span class="left-arrow">%link</span>', __( '&lt;', 'impressivcard' ) );
									
									echo '<a class="icon button back" href="' . get_home_url() . '/#/' . get_option( 'portfolio_slug', 'portfolio' ) . '">' . __( '&#194;', 'impressivcard' ) . '</a>';
									
									previous_post_link( '<span class="right-arrow">%link</span>', __( '=', 'impressivcard' ) );
								?>
							</div>
							<!-- end top nav -->
