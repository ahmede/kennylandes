			...
			<div class="span12">
				<div class="row">
					<div class="span12 portfolio-field portfolio-title">
						<h2><?php echo __( '404', 'impressivcard' ); ?></h2>
					</div>
					<!-- end .portfolio-title -->
				</div>
				<!-- end .row -->
				...
				<div class="row" style="padding-top: 40px; padding-bottom: 40px;">
					<div class="span12">
						<div class="portfolio-field">
							<h3><?php echo __( 'Page Not Found', 'impressivcard' ); ?></h3>
							
							<p><?php echo __( 'The page you are looking for was not found!', 'impressivcard' ); ?></p>
							
							<div class="launch">
								<a class="btn" href="<?php echo get_home_url(); ?>"><?php echo __( 'HOME', 'impressivcard' ); ?></a>
							</div>
							<!-- end .launch -->
						</div>
						<!-- end .portfolio-field -->
