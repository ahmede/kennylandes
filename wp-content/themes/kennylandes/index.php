		...
		<div class="fullwidthbanner">
			<ul>
				...
				<li data-transition="fade" data-slotamount="10" data-thumb="<?php bloginfo('template_url'); ?>/img/thumbs/thumb1.jpg">
	                ...
	                <div class="caption lfl" data-x="-30" data-y="20" data-speed="900" data-start="1300" data-easing="easeOutBack"><img src="<?php bloginfo('template_url'); ?>/img/model1.png"></div>
    ...
    <div id="content" class="container clearfix">
        ...
        <div id="features">
            ...
            <div class="feature one-fourth">
                <div class="feature-icon"><img src="<?php bloginfo('template_url'); ?>/img/services_icon_01.png" alt="" /></div>
            ...
            <div class="feature one-fourth second">
                <div class="feature-icon"><img src="<?php bloginfo('template_url'); ?>/img/services_icon_02.png" alt="" /></div>
                <div class="feature-description">
                    <h4>HTML5 / CSS3</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent et ipsum tellus, vitae sagittis enim. Morbi ultricies ultrices elit vitae</p>
                </div>
            ...
            <div class="feature one-fourth">
                <div class="feature-icon"><img src="<?php bloginfo('template_url'); ?>/img/services_icon_03.png" alt="" /></div>
                <div class="feature-description">
                    <h4>Modern & Clean</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent et ipsum tellus, vitae sagittis enim. Morbi ultricies ultrices elit vitae</p>
                </div>
            ...
            <div class="feature one-fourth last">
                <div class="feature-icon"><img src="<?php bloginfo('template_url'); ?>/img/services_icon_04.png" alt="" /></div>
                <div class="feature-description">
